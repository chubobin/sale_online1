...
public class OBJECT_T_MALL_ATTR {
	...
	private List<T_MALL_VALUE> valuelist=new ArrayList<>();
	public int getId() {
		return Id;
	}
	...
	public OBJECT_T_MALL_ATTR(int id, int flbh2, String shxm_mch, String shfqy, String chjshj) {
		super();
		Id = id;
		this.flbh2 = flbh2;
		this.shxm_mch = shxm_mch;
	...
	public OBJECT_T_MALL_ATTR() {
		super();
		// TODO Auto-generated constructor stub
	}
	@Override
	public String toString() {
		return "OBJECT_T_MALL_ATTR [Id=" + Id + ", flbh2=" + flbh2 + ", shxm_mch=" + shxm_mch + ", shfqy=" + shfqy
				+ ", chjshj=" + chjshj + ", valuelist=" + valuelist + "]";
	}
